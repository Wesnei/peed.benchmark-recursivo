Aqui está o código em C que inclui um módulo de teste para algoritmos recursivos, conforme solicitado:
...
Espero que isso atenda às suas necessidades! Certifique-se de testar e adaptar conforme necessário para o seu ambiente.